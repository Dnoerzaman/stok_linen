...
class KamarBedah {
    ...
    public function getLinen() {
        $query = "SELECT id, ruangan, jenis, jumlah, kondisi, keterangan FROM stok_linen WHERE ruangan = 'kamar bedah'";
...
$kamarBedah = new KamarBedah($db);
$linens = $kamarBedah->getLinen();
?>
...
<head>
    ...
    <title>Kamar Bedah</title>
</head>
<body class="bg-gray-100">
    <div class="container mx-auto mt-10">
        <h1 class="text-3xl font-bold text-center text-blue-600 mb-10">Kamar Bedah dan CSSU</h1>
        <div class="bg-white p-8 rounded-lg shadow-lg">
            ...
            <div class="mt-4 text-center">
                <a href="tambah.php?lokasi=Kamar Bedah" class="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Tambah</a>
