...
class RawatInapJalan {
    ...
    public function getLinen() {
        $query = "SELECT id, jenis, jumlah, kondisi, keterangan FROM stok_linen WHERE ruangan = 'Rawat Inap dan Rawat Jalan'";
...
$rawatInapJalan = new RawatInapJalan($db);
$linens = $rawatInapJalan->getLinen();
?>
...
<head>
    ...
    <title>Rawat Inap dan Rawat Jalan</title>
</head>
<body class="bg-gray-100">
    <div class="container mx-auto mt-10">
        <h1 class="text-3xl font-bold text-center text-blue-600 mb-10">Rawat Inap dan Rawat Jalan</h1>
        <div class="bg-white p-8 rounded-lg shadow-lg">
            ...
            <div class="mt-4 text-center">
                <a href="tambah.php?lokasi=Rawat Inap dan Rawat Jalan" class="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Tambah</a>
